...
async function post(endpoint: string, body: any) {
  ...
  console.log(`🔍 Frontend Debug - BACKEND_URL: ${BACKEND_URL}`);
  console.log(`🔍 Frontend Debug - POST ${url}`);
  console.log(`🔍 Frontend Debug - Body:`, body);
  ...
  try {
    ...
    console.log(`🔍 Frontend Debug - Raw response from ${url}:\n`, text);
    ...
    console.error(`❌ Frontend Debug - POST ${url} failed:`, err.message);
    console.error(`❌ Frontend Debug - Full error:`, err);
    
    if (err.message.includes('Network request failed') || err.message.includes('fetch')) {
      console.error(`❌ Frontend Debug - Network connection failed! Backend might not be running on ${BACKEND_URL}`);
      console.error(`❌ Frontend Debug - Check if backend is running and accessible`);
    }
